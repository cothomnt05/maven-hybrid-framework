...
public class Level_20_Manage_Test_Data_By_External_File extends BaseTest {
	...
	public void beforeClass(String browserName) {
		...
		email = userData.getEmail() + generateFakeNumber() + "@mail.vn";
		...
		System.out.println(userData.getUsernameLogin());
		System.out.println(userData.getPasswordLogin());
